...
public class UploadServletbkp extends HttpServlet {
                ...
                try {
                    ...
                    while (itr.hasNext()) {
                        ...
                        if (item.isFormField()) {
                            ...
                            File savedFile = new File("D:\\upload\\"+itemName);//config.getServletContext().getRealPath("/")+"emp_image\\image\\"+itemName);
...
/*This code is used to duplicate the file with Plain_ as a prefix*/
                            ...
                            String source = "D:\\upload\\"+itemName;
                			...
                			FileReader file = new FileReader("D:\\upload\\"+itemName);

                            String path = "D:\\upload\\"+itemName;
...
//                              
                             ...
                             /* if(Arrays.equals(org_bg, db_bg))
                              {*/
                                  ...
                                  String enc_file = "D:\\upload\\"+file_witout_ext+"."+ext;
