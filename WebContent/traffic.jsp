...
<div class="col span_2_of_3">
	...
	<%} 
        ...
        if((request.getParameter("d"))!= null){
        	String d = request.getParameter("d").replaceAll("-0", "-");
        	System.out.println(d);
        	/* SimpleDateFormat simpleDateFormat2 = new SimpleDateFormat("yyyy-MM-dd");
        	//You gotta parse it to a Date before correcting it
        	Date parsedDate = simpleDateFormat2.parse(request.getParameter("d").replaceAll("-0", "-"));
        	simpleDateFormat2 = new SimpleDateFormat("yyyy-MM-dd");
        	String newFormatttedDate = simpleDateFormat2.format(parsedDate);
        	
        	System.out.println(parsedDate + newFormatttedDate); */
        	
        	
        	DAO data=new DAO();
    		Connection conn=data.getConnection();
    		String validateUser = "select time from  imagevalue where date = ?";
    		...
    		try {
    			...
    			%>
    			    			...
    			    			<tr><td>Sr.no</td><td>Time</td><td>Option</td></tr>
    			<% 
    			while(result.next())
    			{%>
    			<tr><td><%=
    			++i %>
    			<td><a href="<%=request.getContextPath() %>/vehicle.jsp?t=<%=result.getString(1) %>"><%=result.getString(1) %></a>
    			</td>
    			<td>
    			<a href="<%=request.getContextPath() %>/vehicle.jsp?t=<%=result.getString(1) %>">View</a>
    			</tr>
     ...
     GF.DeleteFile();
        ...
        %>
                        ...
                        %>
                          	  ...
                          	  <%if((request.getParameter("d"))== null){%> 
                      <form class="form1" action="<%=request.getContextPath() %>/traffic.jsp" method="post"  >
                      ...
                      /*   ArrayList<String> folderList = admin.getFileList(); */
                        ...
                        %>
                        <div>
						     	 	<span>                          <input     class="custom-select" type="date" name="d" placeholder="Enter Date">
